...
import lu.kainovaii.tuske.util.SimpleType;
		...
		new SimpleType<Recipe>(Recipe.class, "recipe", "recipes?") {
			...
			public void change(Recipe[] recipes, Object[] set, ChangeMode mode) {
				if (mode == ChangeMode.DELETE)
					Main.getRecipeManager().removeRecipe(recipes);
				else if (mode == ChangeMode.RESET)
					Main.getRecipeManager().removeCustomRecipe(recipes);
			}}
				.name("Recipe")
