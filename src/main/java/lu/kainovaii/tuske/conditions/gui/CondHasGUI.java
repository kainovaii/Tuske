package lu.kainovaii.tuske.conditions.gui;
	...
	public boolean check(Event e) {
		...
		if (obj != null){
			if (obj.getSingle(e) == null) 
				return false;
			r = Main.getGUIManager().isGUI(p.getSingle(e).getOpenInventory().getTopInventory(), ((Number)obj.getSingle(e)).intValue());
		} else
			r = Main.getGUIManager().hasGUI(p.getSingle(e).getOpenInventory().getTopInventory());
		if (isNegated())
			r = !r;
		return r;
	}
