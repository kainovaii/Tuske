package lu.kainovaii.tuske.hooks.legendchat.expressions;

import lu.kainovaii.tuske.hooks.legendchat.LegendchatRegister;
import lu.kainovaii.tuske.hooks.legendchat.LegendchatConfig;
...
public class ExprTagChat extends SimpleExpression<String>{
	...
	static {
		Registry.newProperty(ExprTagChat.class, "[chat] tag %string%", "offlineplayer");
	}
