package lu.kainovaii.tuske.hooks.legendchat;
...
import lu.kainovaii.tuske.listeners.TagChat;
...
public class LegendchatConfig {
	...
	public LegendchatConfig(Main instance){
		file = new File(instance.getDataFolder(), "tags.yml");
		instance.getServer().getPluginManager().registerEvents(new TagChat(this), instance);
	}
