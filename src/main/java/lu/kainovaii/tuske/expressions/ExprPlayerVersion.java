...
import lu.kainovaii.tuske.documentation.Dependency;
	...
	static {
		...
		if (viaversion != null) {
			if (ReflectionUtils.hasMethod(ViaVersionPlugin.class, "getApi")) {
				...
				Main.log("Couldn't hook with ViaVersion because it's outdated. Atleast version 1.0 is required.", Level.WARNING);
		}
